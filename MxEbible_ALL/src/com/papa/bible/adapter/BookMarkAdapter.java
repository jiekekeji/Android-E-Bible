...
public class BookMarkAdapter extends BaseAdapter {
	...
	public BookMarkAdapter(Activity activity, List<VerseInfo> bibles) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.adapter_item_bookmark_list, null);
...
//		holder.note_time_tv.setText(info.getReserve05());
		return convertView;
	}
