...
public class VerseSearchAdapter extends BaseAdapter {

	private static final String TAG = VerseSearchAdapter.class.getSimpleName();
	private Activity activity;
	private List<VerseInfo> bibles;
	private LayoutInflater mInflater;

	public VerseSearchAdapter(Activity activity, List<VerseInfo> bibles) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.adapter_item_verse_search_list, null);
