...
public class VerseInfo {
	...
	private String reserve07;// 高亮的时间
	...
	public String toString() {
		return "VerseInfo [bookID=" + bookID + ", bookName=" + bookName + ", chapter=" + chapter + ", section="
				+ section + ", verse=" + verse + ", bgcolor=" + bgcolor + ", reserve07=" + reserve07 + ", underline="
				+ underline + ", reserve06=" + reserve06 + ", reserve01=" + reserve01 + ", reserve02=" + reserve02
				+ ", reserve03=" + reserve03 + ", reserve04=" + reserve04 + ", reserve05=" + reserve05 + ", media="
				+ media + "]";
	}
